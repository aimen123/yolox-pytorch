...
class COCODataset(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, img_size=(640, 640), name="train2007", json_file="instances_train2007.json", preproc=None,
...
def get_dataloader(opt, no_aug=False, logger=None, val_loader=True):
    ...
    train_dataset = COCODataset(opt,
                                ...
                                preproc=TrainTransform(rgb_means=opt.rgb_means, std=opt.std, max_labels=120, tracking=do_tracking, augment=True),
                                no_aug=no_aug,
    ...
    val_dataset = COCODataset(opt,
                              ...
                              preproc=TrainTransform(rgb_means=opt.rgb_means, std=opt.std, max_labels=120, tracking=do_tracking, augment=False),
                              no_aug=True,
                              tracking=do_tracking,
                              logger=logger)
...
def main():
    ...
    opt.dataset_path = "/data/voc_data"
    opt.train_ann = opt.dataset_path + "/annotations/instances_train2007.json"
    opt.val_ann = opt.dataset_path + "/annotations/instances_val2007.json"
